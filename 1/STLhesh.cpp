...
int main(){
    ...
    std::unordered_set<int> set1={1,5,3,4,2};
    std::cout<<"set1의 초기값";print(set1);
    set1.insert(2);
    std::cout<<"2 삽입: ";print(set1);

    set1.insert(10);
    set1.insert(300);
    std::cout<<"10,300삽입: "; print(set1);
    ...
    set2.insert({2,4});
    set2[3]=9;
    std::cout<<"2,3의 제곱 삽입: "; print(set2);

    set2[20]=400;
    set2[30]=900;

    std::cout<<"20, 30 의 제곱 삽입: "; print(set2);

    find(set2,10);
    find(set2,20);
    std::cout<<"set2[3]= "<<set2[3]<<std::endl;
    std::cout<<"set2[100]="<<set2[100]<<std::endl;
    print(set2);
